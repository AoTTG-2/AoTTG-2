            ...
            else
            {
                if (this.state == TitanState.hit)
                {
                    if (this.hitPause > 0f)
                    {
                        ...
                        if (this.hitPause <= 0f)
                        {
                            base.GetComponent<Animation>()[this.hitAnimation].speed = 1f;
                            this.hitPause = 0f;
                        }
                    }
                ...
                else
                {
                    ...
                    {
                        if (base.GetComponent<Animation>().IsPlaying("idle"))
                        {
                            this.stamina += Time.deltaTime * 30f;
                        }
                        if (base.GetComponent<Animation>().IsPlaying("crawler_idle"))
                        {
                    ...
                    if (base.GetComponent<Animation>().IsPlaying("run_abnormal_1"))
                    {
                ...
                {
                    if (base.GetComponent<Animation>()["laugh"].normalizedTime >= 1f)
                    {
                        this.idle(2f);
                    }
                }
                else if (this.state != TitanState.idle)
                {
                    if (this.state == TitanState.attack)
                    {
                        if (this.attackAnimation == "combo")
                        {
                            if (this.nonAI)
                            {
                                ...
                                if (!this.nonAIcombo && (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= 0.385f))
                                {
                                    this.idle(0f);
                                    return;
                                }
                            }
                            if ((base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= 0.11f) && (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime <= 0.16f))
                            {
                            ...
                            if ((base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= 0.27f) && (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime <= 0.32f))
                            {
                        ...
                        if (((this.attackCheckTimeA != 0f) && (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= this.attackCheckTimeA)) && (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime <= this.attackCheckTimeB))
                        {
                        ...
                        {
                            if (!this.attacked && (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= 0.11f))
                            {
                                this.attacked = true;
                                Transform transform = base.transform.Find("Amarture/Core/Controller_Body/hip/spine/chest/shoulder_R/upper_arm_R/forearm_R/hand_R/hand_R_001");
                                if ((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.MULTIPLAYER) && base.photonView.isMine)
                            ...
                            if (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= 0.11f)
                            {
                            ...
                            if ((this.throwRock != null) && (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= 0.62f))
                            {
                                Vector3 vector28;
                                float num3 = 1f;
                                float num4 = -20f;
                                if (this.myHero != null)
                                {
                                    vector28 = ((Vector3) ((this.myHero.transform.position - this.throwRock.transform.position) / num3)) + this.myHero.GetComponent<Rigidbody>().velocity;
                        ...
                        if ((this.attackAnimation != "jumper_0") && (this.attackAnimation != "crawler_jump_0"))
                        {
                            if ((this.attackAnimation != "jumper_1") && (this.attackAnimation != "crawler_jump_1"))
                            {
                                ...
                                {
                                    if (!base.GetComponent<Animation>().IsPlaying("tired"))
                                    {
                                        if (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= (1f + this.attackEndWait))
                                        {
                                    ...
                                    else if (base.GetComponent<Animation>()["tired"].normalizedTime >= (1f + Mathf.Max((float) (this.attackEndWait * 2f), (float) 3f)))
                                    {
                                        this.idle(UnityEngine.Random.Range((float) (this.attackWait - 1f), (float) 3f));
                                    }
                                }
                            ...
                            else if ((base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= 1f) && this.grounded)
                            {
                                GameObject obj13;
                                if (this.TitanType == TitanType.TYPE_CRAWLER)
                                {
                        ...
                        else
                        {
                            if (!this.attacked)
                            {
                                if (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= 0.68f)
                                {
                                    this.attacked = true;
                                    if ((this.myHero != null) && !this.nonAI)
                                    {
                                        ...
                                        Vector3 vector35 = (Vector3) ((this.myHero.transform.position + (this.myHero.GetComponent<Rigidbody>().velocity * num16)) + ((((Vector3.up * 0.5f) * num10) * num16) * num16));
                                        ...
                                        if ((num15 < 0f) || ((num17 - num12) < 0f))
                                        {
                                            ...
                                            base.GetComponent<Rigidbody>().velocity = vector36;
                                            return;
                                        }
                                        ...
                                        base.GetComponent<Rigidbody>().AddForce((Vector3) (Vector3.up * num18), ForceMode.VelocityChange);
                                    ...
                                    else
                                    {
                                        ...
                                        base.GetComponent<Rigidbody>().velocity = vector31;
                                    }
                                }
                                else
                                {
                            ...
                            if (base.GetComponent<Animation>()["attack_" + this.attackAnimation].normalizedTime >= 1f)
                            {
                                ...
                                if (((Mathf.Abs(base.GetComponent<Rigidbody>().velocity.y) < 0.5f) || (base.GetComponent<Rigidbody>().velocity.y < 0f)) || this.IsGrounded())
                                {
                                    if (this.TitanType == TitanType.TYPE_CRAWLER)
                                    {
                                        this.attackAnimation = "crawler_jump_1";
                    ...
                    {
                        if (((base.GetComponent<Animation>()["grab_" + this.attackAnimation].normalizedTime >= this.attackCheckTimeA) && (base.GetComponent<Animation>()["grab_" + this.attackAnimation].normalizedTime <= this.attackCheckTimeB)) && (this.grabbedTarget == null))
                        {
                        ...
                        if (base.GetComponent<Animation>()["grab_" + this.attackAnimation].normalizedTime >= 1f)
                        {
                            if (this.grabbedTarget != null)
                            {
                                this.eat();
                    ...
                    {
                        if (!this.attacked && (base.GetComponent<Animation>()[this.attackAnimation].normalizedTime >= 0.48f))
                        {
                            this.attacked = true;
                    ...
                    else if (this.state == TitanState.chase)
                    {
                        ...
                        else if (!this.longRangeAttackCheck())
                        {
                            ...
                            else if (((this.TitanType == TitanType.TYPE_JUMPER) && (((this.myDistance > this.attackDistance) && (this.myHero.transform.position.y > (this.head.position.y + (4f * this.myLevel)))) || (this.myHero.transform.position.y > (this.head.position.y + (4f * this.myLevel))))) && (Vector3.Distance(base.transform.position, this.myHero.transform.position) < (1.5f * this.myHero.transform.position.y)))
                            {
                    ...
                    else if (this.state != TitanState.wander)
                    {
                        ...
                        {
                            if (base.GetComponent<Animation>().IsPlaying("sit_hit_eye") && (base.GetComponent<Animation>()["sit_hit_eye"].normalizedTime >= 1f))
                            {
                                this.remainSitdown();
                            }
                            else if (base.GetComponent<Animation>().IsPlaying("hit_eye") && (base.GetComponent<Animation>()["hit_eye"].normalizedTime >= 1f))
                            {
                                if (this.nonAI)
                                {
                                    this.idle(0f);
                        ...
                        else if (this.state == TitanState.down)
                        {
                            ...
                            if (base.GetComponent<Animation>().IsPlaying("sit_hunt_down") && (base.GetComponent<Animation>()["sit_hunt_down"].normalizedTime >= 1f))
                            {
                                this.playAnimation("sit_idle");
                            }
                            ...
                            if (base.GetComponent<Animation>().IsPlaying("sit_getup") && (base.GetComponent<Animation>()["sit_getup"].normalizedTime >= 1f))
                            {
                                this.idle(0f);
                            }
                        }
                        else if (this.state == TitanState.sit)
                        {
                            ...
                            if (base.GetComponent<Animation>().IsPlaying("sit_down") && (base.GetComponent<Animation>()["sit_down"].normalizedTime >= 1f))
                            {
                                this.playAnimation("sit_idle");
                            }
                            if (((this.getdownTime <= 0f) || this.isAlarm) && base.GetComponent<Animation>().IsPlaying("sit_idle"))
                            {
                                this.crossFade("sit_getup", 0.1f);
                            }
                            if (base.GetComponent<Animation>().IsPlaying("sit_getup") && (base.GetComponent<Animation>()["sit_getup"].normalizedTime >= 1f))
                        ...
                        else if (this.state == TitanState.recover)
                        {
                            ...
                            if (base.GetComponent<Animation>().IsPlaying("idle_recovery") && (base.GetComponent<Animation>()["idle_recovery"].normalizedTime >= 1f))
                            {
                                this.idle(0f);
                            }
                        }
                ...
                else
                {
                    ...
                    if (!this.longRangeAttackCheck())
                    {
                        ...
                        {
                            if (((this.TitanType == TitanType.TYPE_JUMPER) && ((this.myDistance > this.attackDistance) || (this.myHero.transform.position.y > (this.head.position.y + (4f * this.myLevel))))) && ((Mathf.Abs(this.between2) < 120f) && (Vector3.Distance(base.transform.position, this.myHero.transform.position) < (1.5f * this.myHero.transform.position.y))))
                            {
                                this.attack("jumper_0");
                                return;
                            }
                        ...
                        else
                        {
                            if (this.myDistance < this.attackDistance)
                            {
                                ...
                                if (((this.TitanType == TitanType.TYPE_JUMPER) || (this.TitanType == TitanType.TYPE_I)) && (Mathf.Abs(this.between2) > 40f))
                                {
