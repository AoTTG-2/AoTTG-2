...
public class FEMALE_TITAN : MonoBehaviour
{
    ...
    {
        if ((!IN_GAME_MAIN_CAMERA.isPausing || (IN_GAME_MAIN_CAMERA.gametype != GAMETYPE.SINGLE)) &&  base.photonView.isMine)
        {
    ...
    private void killPlayer(GameObject hitHero)
    {
        if (hitHero != null)
        {
            ...
            if (((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.MULTIPLAYER) && PhotonNetwork.isMasterClient) && !hitHero.GetComponent<Hero>().HasDied())
            {
