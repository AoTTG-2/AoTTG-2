...
namespace Assets.Scripts.Characters.Humans.Skills
{
    ...
    /// <summary>
    /// Boom logic attached to the explosion prefab.
    /// </summary>
    public class ThunderSpearExplosion : Photon.MonoBehaviour
    {

        private const float BladeRotationSpeed = 1f; // In degrees
        private const float BladeLifeTime = 1f; // In seconds
        ...
        {
            return (int)((baseVelocity.magnitude ) * lifeTime / BladeLifeTime * 5f);
        }
