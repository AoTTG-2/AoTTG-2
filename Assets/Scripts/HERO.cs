...
public class HERO : Photon.MonoBehaviour
{
    ...
    public void setStat()
    {
        ...
        base.GetComponent<Rigidbody>().mass = 0.5f - ((this.setup.myCostume.stat.ACL - 100) * 0.001f);
            ...
            if (!this.hasDied)
            {
                ...
                if ((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE) || base.photonView.isMine)
                {
                    if ((this.state == HERO_STATE.Grab) && !this.useGun)
                    {
                        if (this.skillId == "jean")
                        {
                            if (((this.state != HERO_STATE.Attack) && (this.inputManager.isInputDown[InputCode.attack0] || this.inputManager.isInputDown[InputCode.attack1])) && ((this.escapeTimes > 0) && !base.GetComponent<Animation>().IsPlaying("grabbed_jean")))
                            {
                                this.playAnimation("grabbed_jean");
                                base.GetComponent<Animation>()["grabbed_jean"].time = 0f;
                                this.escapeTimes--;
                            }
                            if ((base.GetComponent<Animation>().IsPlaying("grabbed_jean") && (base.GetComponent<Animation>()["grabbed_jean"].normalizedTime > 0.64f)) && (this.titanWhoGrabMe.GetComponent<TITAN>() != null))
                            {
                                this.ungrabbed();
                                base.GetComponent<Rigidbody>().velocity = (Vector3) (Vector3.up * 30f);
                                if (IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE)
                                {
                    ...
                    else if (!this.titanForm)
                    {
                        ...
                        {
                            if ((this.inputManager.isInputDown[InputCode.jump] && !base.GetComponent<Animation>().IsPlaying("jump")) && !base.GetComponent<Animation>().IsPlaying("horse_geton"))
                            {
                                this.idle();
                                this.crossFade("jump", 0.1f);
                                this.sparks.enableEmission = false;
                            }
                            if ((this.inputManager.isInputDown[InputCode.dodge] && !base.GetComponent<Animation>().IsPlaying("jump")) && !base.GetComponent<Animation>().IsPlaying("horse_geton"))
                            {
                                this.dodge2(false);
                                return;
                            }
                        ...
                        if (this.state == HERO_STATE.Idle)
                        {
                            ...
                            if (base.GetComponent<Animation>().IsPlaying(this.standAnimation) && this.inputManager.isInputDown[InputCode.salute])
                            {
                                this.salute();
                                return;
                            }
                            if ((!this.isMounted && (this.inputManager.isInputDown[InputCode.attack0] || this.inputManager.isInputDown[InputCode.attack1])) && !this.useGun)
                            {
                                ...
                                if (this.inputManager.isInputDown[InputCode.attack1])
                                {
                                    if ((this.skillCDDuration <= 0f) && !flag2)
                                    {
                                        ...
                                        else if (this.skillId == "mikasa")
                                        {
                                            ...
                                            base.GetComponent<Rigidbody>().velocity = (Vector3) (Vector3.up * 10f);
                                        }
                                ...
                                if (!flag2)
                                {
                                    ...
                                    if (this.grounded)
                                    {
                                        base.GetComponent<Rigidbody>().AddForce((Vector3) (base.gameObject.transform.forward * 200f));
                                    }
                                    this.playAnimation(this.attackAnimation);
                        ...
                        else if (this.state == HERO_STATE.Attack)
                        {
                            if (!this.useGun)
                            {
                                ...
                                if (!this.attackReleased)
                                {
                                    ...
                                    else if (base.GetComponent<Animation>()[this.attackAnimation].normalizedTime >= 0.32f)
                                    {
                                        this.pauseAnimation();
                                    }
                                }
                                ...
                                {
                                    if (base.GetComponent<Animation>()[this.attackAnimation].normalizedTime >= 0.8f)
                                    {
                                ...
                                else
                                {
                                    ...
                                    if ((base.GetComponent<Animation>()[this.attackAnimation].normalizedTime > num2) && (base.GetComponent<Animation>()[this.attackAnimation].normalizedTime < num))
                                    {
                                        if (!this.checkBoxLeft.GetComponent<TriggerColliderWeapon>().active_me)
                                        {
                                            this.checkBoxLeft.GetComponent<TriggerColliderWeapon>().active_me = true;
                                    ...
                                    if ((this.attackLoop > 0) && (base.GetComponent<Animation>()[this.attackAnimation].normalizedTime > num))
                                    {
                                        this.attackLoop--;
                                ...
                                if (base.GetComponent<Animation>()[this.attackAnimation].normalizedTime >= 1f)
                                {
                                    if ((this.attackAnimation != "special_marco_0") && (this.attackAnimation != "special_marco_1"))
                                    {
                                        ...
                                        {
                                            Rigidbody rigidbody3 = base.GetComponent<Rigidbody>();
                                ...
                                if (base.GetComponent<Animation>().IsPlaying("attack3_2") && (base.GetComponent<Animation>()["attack3_2"].normalizedTime >= 1f))
                                {
                                    this.falseAttack();
                                    this.idle();
                                }
                            ...
                            else
                            {
                                ...
                                if (!this.attackReleased && (base.GetComponent<Animation>()[this.attackAnimation].normalizedTime > 0.167f))
                                {
                                    GameObject obj4;
                                    this.attackReleased = true;
                                    bool flag6 = false;
                                    if ((this.attackAnimation != "AHSS_shoot_both") && (this.attackAnimation != "AHSS_shoot_both_air"))
                                    {
                                        ...
                                        base.GetComponent<Rigidbody>().AddForce((Vector3) (-base.transform.forward * 600f), ForceMode.Acceleration);
                                    }
                                    else
                                    {
                                        flag6 = true;
                                        this.leftGunHasBullet = false;
                                        this.rightGunHasBullet = false;
                                        base.GetComponent<Rigidbody>().AddForce((Vector3) (-base.transform.forward * 1000f), ForceMode.Acceleration);
                                    }
                                    base.GetComponent<Rigidbody>().AddForce((Vector3) (Vector3.up * 200f), ForceMode.Acceleration);
                                ...
                                if (!base.GetComponent<Animation>().IsPlaying(this.attackAnimation))
                                {
                                    this.falseAttack();
                                    this.idle();
                                }
                        ...
                        else if (this.state == HERO_STATE.ChangeBlade)
                        {
                            if (this.useGun)
                            {
                                if (base.GetComponent<Animation>()[this.reloadAnimation].normalizedTime > 0.22f)
                                {
                                    ...
                                    if (!this.rightGunHasBullet && this.setup.part_blade_r.activeSelf)
                                    {
                                        ...
                                        obj6.GetComponent<Rigidbody>().AddForce(vector4, ForceMode.Impulse);
                                        ...
                                        obj6.GetComponent<Rigidbody>().AddTorque(vector5, ForceMode.Acceleration);
                                    }
                                }
                                if ((base.GetComponent<Animation>()[this.reloadAnimation].normalizedTime > 0.62f) && !this.throwedBlades)
                                {
                                ...
                                if (base.GetComponent<Animation>()[this.reloadAnimation].normalizedTime > 1f)
                                {
                                    this.idle();
                                }
                            }
                            else
                            {
                                ...
                                {
                                    if ((base.GetComponent<Animation>()[this.reloadAnimation].normalizedTime >= 0.13f) && !this.throwedBlades)
                                    {
                                        this.throwedBlades = true;
                                        if (this.setup.part_blade_l.activeSelf)
                                        {
                                    ...
                                    if ((base.GetComponent<Animation>()[this.reloadAnimation].normalizedTime >= 0.37f) && (this.currentBladeNum > 0))
                                    {
                                        this.setup.part_blade_l.SetActive(true);
                                        this.setup.part_blade_r.SetActive(true);
                                        this.currentBladeSta = this.totalBladeSta;
                        ...
                        {
                            if (base.GetComponent<Animation>()["salute"].normalizedTime >= 1f)
                            {
                                this.idle();
                            }
                        }
                        ...
                        {
                            if (base.GetComponent<Animation>().IsPlaying("dodge"))
                            {
                                if (!this.grounded && (base.GetComponent<Animation>()["dodge"].normalizedTime > 0.6f))
                                {
                                    this.idle();
                                }
                                if (base.GetComponent<Animation>()["dodge"].normalizedTime >= 1f)
                                {
                                    this.idle();
                                }
                            }
                        ...
                        {
                            if (base.GetComponent<Animation>().IsPlaying("dash_land") && (base.GetComponent<Animation>()["dash_land"].normalizedTime >= 1f))
                            {
                                this.idle();
                            }
                        }
                        ...
                        {
                            if (base.GetComponent<Animation>().IsPlaying("supply") && (base.GetComponent<Animation>()["supply"].normalizedTime >= 1f))
                            {
                                this.currentBladeSta = this.totalBladeSta;
                        ...
                        else if (this.state == HERO_STATE.AirDodge)
                        {
                            if (this.dashTime > 0f)
                            {
                                ...
                                {
                                    base.GetComponent<Rigidbody>().AddForce((Vector3) ((-base.GetComponent<Rigidbody>().velocity * Time.deltaTime) * 1.7f), ForceMode.VelocityChange);
                                }
                            }
                            else
                            {
                        ...
                        if (((this.inputManager.isInput[InputCode.leftRope] && !base.GetComponent<Animation>().IsPlaying("attack3_1")) && (!base.GetComponent<Animation>().IsPlaying("attack5") && !base.GetComponent<Animation>().IsPlaying("special_petra"))) && ((this.state != HERO_STATE.ChangeBlade) && (this.state != HERO_STATE.Grab)))
                        {
                            if (this.bulletLeft != null)
                            {
                                this.QHold = true;
                        ...
                        if (this.inputManager.isInput[InputCode.rightRope] && (((!base.GetComponent<Animation>().IsPlaying("attack3_1") && !base.GetComponent<Animation>().IsPlaying("attack5")) && !base.GetComponent<Animation>().IsPlaying("special_petra")) || (this.state == HERO_STATE.Idle)))
                        {
                            if (this.bulletRight != null)
                            {
                                this.EHold = true;
                        ...
                        if (this.inputManager.isInput[InputCode.bothRope] && (((!base.GetComponent<Animation>().IsPlaying("attack3_1") && !base.GetComponent<Animation>().IsPlaying("attack5")) && !base.GetComponent<Animation>().IsPlaying("special_petra")) || (this.state == HERO_STATE.Idle)))
                        {
                            this.QHold = true;
                            this.EHold = true;
                            if ((this.bulletLeft == null) && (this.bulletRight == null))
                ...
                if ((IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE) || base.photonView.isMine)
                {
                    ...
                    else if (!this.titanForm && !this.isCannon)
                    {
                        ...
                        if (this.state == HERO_STATE.Idle)
                        {
                            ...
                            if (((base.GetComponent<Animation>().IsPlaying(this.standAnimation) || !this.grounded) && this.inputManager.isInputDown[InputCode.reload]) && ((!this.useGun || (RCSettings.ahssReload != 1)) || this.grounded))
                            {
                                this.changeBlade();
                                return;
                            }
