...
namespace MapEditor
{
    ...
    public class HandleUtility
    {
		 ...
		 */
        public static bool ClosestPointsOnTwoLines(Vector3 linePoint1, Vector3 lineVec1, Vector3 linePoint2,
            Vector3 lineVec2, out Vector3 closestPointLine1, out Vector3 closestPointLine2)
        {
        ...
        {
            return ClosestPointsOnTwoLines(InLineA.origin, InLineA.direction, InLineB.origin, InLineB.direction,
                out OutPointA, out OutPointB);
        }
		 ...
		 */
        public static float DistancePoint2DToLine(Camera cam, Vector2 mousePosition, Vector3 worldPosition1,
