...
Shader "Vwater"
{
	Properties
	{
		...
		_LargeWaveSpeed("Large Wave Speed", Float) = 2
		_SmallWaveSpeed("Small Wave Speed", Float) = 0.15
		_MediumWaveSpeed("Medium Wave Speed", Float) = 1
		_LargeWaveDirection("Large Wave Direction", Range( 0 , 6.24)) = 0
		_MediumWaveDirection("Medium Wave Direction", Range( 0 , 6.24)) = 0
		_SmallWaveDirection("Small Wave Direction", Range( 0 , 6.24)) = 0
		_LargeWavesFlow("Large Waves Flow", Range( 0 , 1)) = 1
		_MediumWavesFlow("Medium Waves Flow", Range( 0 , 1)) = 1
		_SmallWavesFlow("Small Waves Flow", Range( 0 , 1)) = 1
		_largeWavesTilling("large Waves Tilling", Float) = 342
		_SmallWavesTilling("Small Waves Tilling", Float) = 9.26
		_MediumWavesTilling("Medium Waves Tilling", Float) = 44.64
		_EdgeBlending("Edge Blending", Range( 0 , 1)) = 0.286
		_LifeDensity("Life Density", Range( 0 , 100)) = 0.382
		_WaterDensity("Water Density", Range( 0 , 100)) = 0.076
		_WaterDepth("Water Depth", Range( 0 , 1)) = 0.795
		_LifeDepth("Life Depth", Range( 0 , 1)) = 0.2
		_LifeColor("Life Color", Color) = (1,0.7783019,0.9634851,0)
		_WaterAbsorbedColor("Water Absorbed Color", Color) = (0,0,0,0)
		_foam("foam", 2D) = "white" {}
		_FoamTilling("Foam  Tilling", Float) = 10
		_FoamColor("Foam Color", Color) = (1,1,1,0)
		_FoamDistance("Foam Distance", Range( 0 , 10)) = 0.136
		_WaveFoam("Wave Foam", Range( 0 , 1)) = 0
		_FoamSpeed("Foam Speed", Float) = 0.02
		_Scatteringpower("Scattering power", Float) = 20.52
		_ScatteringScale("Scattering Scale", Float) = 3
		_FoamSoftness("Foam Softness", Range( 0.0001 , 1)) = 0.143
		[ASEEnd]_Scatteringbrightness("Scattering brightness", Range( 0 , 1)) = 0.14
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 Life161 = saturate( ( _MainLightColor - _LifeColor ) );
				...
				float4 DepthColor154 = saturate( ( _MainLightColor - _WaterAbsorbedColor ) );
...
/*ASEBEGIN
Version=18900
-1680;19;1680;989;3018.006;-701.0811;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-3414.815,10.62195;Inherit;False;Property;_LargeWavesHeight;Large Waves Height;4;0;Create;True;0;0;0;False;0;False;0.4170583;1.060296;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-2848.725,644.192;Inherit;False;Property;_MediumWavesHeight;Medium Waves Height;5;0;Create;True;0;0;0;False;0;False;0.4825;1.05;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;118;-2142.493,1163.045;Inherit;False;Property;_SmallWavesHeight;Small Waves Height;6;0;Create;True;0;0;0;False;0;False;0.4328485;0.52789;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;178;-5704.876,-947.1312;Inherit;True;Property;_foam;foam;26;0;Create;True;0;0;0;False;0;False;-1;None;0b4f478d82787eb44841a460fb184392;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;185;-4715.968,-1026.416;Inherit;False;Property;_FoamDistance;Foam Distance;29;0;Create;True;0;0;0;False;0;False;0.5411765;1.36;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;171;-2911.454,-1231.177;Inherit;False;909.396;686.0884;colors;10;158;157;151;159;150;152;160;161;156;154;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;278;-2001.427,-1659.2;Inherit;False;1695.421;460.7161;color processing;17;143;169;170;166;138;147;149;167;164;148;168;163;155;145;162;141;144;;0.9144705,0.6618013,0.9811321,1;0;0
Node;AmplifyShaderEditor.LightColorNode;158;-2795.722,-1018.286;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;138;-1948.996,-1409.391;Inherit;False;Property;_WaterDensity;Water Density;21;0;Create;True;0;0;0;False;0;False;0.4588235;0.076;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;136;-1606.334,1397.119;Inherit;False;Property;_EdgeBlending;Edge Blending;19;0;Create;True;0;0;0;False;0;False;0.4588235;0.286;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;145;-1355.872,-1335.903;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;369;-3208.693,-999.5728;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;141;-676.011,-1391.525;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;173;-789.8633,-120.4009;Inherit;True;177;Foam;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;144;-530.011,-1409.525;Inherit;False;FinalColored;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;329;-518.3701,-117.9603;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;5;-546.7976,-38.74023;Inherit;False;144;FinalColored;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;249;-2674.189,1583.848;Inherit;False;Property;_ScatteringScale;Scattering Scale;33;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;257;-602.7888,155.5319;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;350;-2808.075,-948.3386;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;266;-711.9147,288.4965;Inherit;False;Property;_Scatteringbrightness;Scattering brightness;35;0;Create;True;0;0;0;False;0;False;0.3;0.872;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-733.4706,396.9374;Inherit;False;Property;_WaterSmoothness;Water Smoothness;3;0;Create;True;0;0;0;False;0;False;0.99;0.98;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;175;-272.6277,-127.3215;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;247;-2881.189,1581.848;Inherit;False;Property;_Scatteringpower;Scattering power;32;0;Create;True;0;0;0;False;0;False;0;20.52;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=14BB661711B9967AB5B9E35CD557453EFDBBCC9B