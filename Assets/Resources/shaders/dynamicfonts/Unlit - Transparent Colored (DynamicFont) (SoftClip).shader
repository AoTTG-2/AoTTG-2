...
ADD R0.xy, -R0, c[1].x;
MUL R0.xy, R0, c[0];
MIN_SAT R1.x, R0, R0.y;
MUL R0, R0.w, fragment.color.primary;
...
BindCB  "$Globals" 0
"ps_4_0
eefiecedhmnhlaekmjnbimffefipanhidiaohlfnabaaaaaadmacaaaaadaaaaaa
...
aaaaaaaaaagabaaaaaaaaaaadiaaaaahpcaabaaaabaaaaaapgapbaaaabaaaaaa
...
BindCB  "$Globals" 0
"ps_4_0_level_9_1
eefiecedclmjnojkaapccbmhkbmhkcgdaikcfpglabaaaaaadiadaaaaaeaaaaaa
...
aaaaoeiaaaaaoekaakaaaaadabaabiiaaaaaffiaaaaaaaiaafaaaaadaaaacpia
aaaappiaaaaaoelaafaaaaadaaaaciiaabaappiaaaaappiaabaaaaacaaaicpia
...
aagabaaaaaaaaaaadiaaaaahpcaabaaaabaaaaaapgapbaaaabaaaaaaegbobaaa
